...
def main():
    ...
    result.get()
    print("Attribute update sent: " + str(result.rc() == TicosPublishInfo.TICOS_ERR_SUCCESS))
    result = client.send_attributes(attributes)
    result.get()
    print("Telemetry update sent: " + str(result.rc() == TicosPublishInfo.TICOS_ERR_SUCCESS))
    client.disconnect()
